...
exports.create  = (req,res) => {
    ...
    {
        specializationsArray.push(req.body["Specialization"+specializationsCount]);
    ...
    {
        adminWorkAddressArray.push(req.body["adminWorkAddress"+adminWorkAddressCount]);
    ...
    {
        identityWebsiteArray.push(req.body["IdentityWebsite"+identityWebsiteCount]);
