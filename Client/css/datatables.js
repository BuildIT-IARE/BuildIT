 ...
 *   https://datatables.net/download/#bs4/dt-1.10.20/fh-3.1.6/r-2.2.3/rg-1.1.1/sc-2.0.1/sp-1.0.1
 *
 * Included libraries:
 *   DataTables 1.10.20, FixedHeader 3.1.6, Responsive 2.2.3, RowGroup 1.1.1, Scroller 2.0.1, SearchPanes 1.0.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.20/fh-3.1.6/r-2.2.3/rg-1.1.1/sc-2.0.1/sp-1.0.1",
